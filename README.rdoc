...
Before code(for existing textArea ):
...
After code:
 ...
 # <?php $this->widget('ext.kindeditor.KindEditor',	array(
						'textAreaId'=>= CHtml::activeId($this->model, 'content');
						)
					); ?>
use together with the CActiveForm or its subClass

 # <?php echo $form->labelEx($model,'content'); ?>
 # <?php $this->widget('ext.kindeditor.KindEditor',  array(
  ¡®model¡¯=>$model, ¡®attribute¡¯=>¡®content¡¯,
